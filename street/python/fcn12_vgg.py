...
class FCN:
    ...
    def build(self, rgb, train=False, num_classes=2, random_init_fc8=True,
        ...
        self.upscore_to_conv3_3 = self._upscore_layer(self.fuse_pool3,
                                             shape=tf.shape(self.conv3_3),
                                             num_classes=num_classes,
                                             debug=debug, name='upscore_to_conv3_3',
                                             ksize=4, stride=2)
        self.process_output = tf.concat([self.conv3_3, self.upscore_to_conv3_3], 3)
        output_shape = [d.value for d in self.conv3_3.shape]
